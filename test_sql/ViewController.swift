...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        sql = "INSERT INTO people (id, name, phone, datepic ) VALUES " +
            "('1','เลย์','โลตัส','01/03/2019'), " +
            "('2','เทสโต้','เซเว่น','05/03/2019'), " +
            "('3','ปีโป้','บิ้กซี','07/03/2019'), " +
        "('4','ดีโด้','แม็คโคร','08/03/2019')"
    ...
    func select () {
        ...
        while(sqlite3_step(pointer) == SQLITE_ROW){
            ...
            textView.text?.append("ชื่อสินค้า: \(name)\n")
            
            phone = String(cString: sqlite3_column_text(pointer,2))
            textView.text?.append("ชื่อสถานที่: \(phone)\n")
